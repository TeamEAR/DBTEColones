...
-- Parametro de Entrada: <Nombre, PrimerApellido, SegundoApellido, Identificacion, Correo, Contrase�a, Telefono, NombreRol>
...
BEGIN
	...
	BEGIN TRY
		...
		VALUES (@Nombre, @PrimerApellido, @SegundoApellido, @Identificacion, @Contraséña, @IdTipoRol)
...
-- Parametro de Entrada: <Nombre, PrimerApellido, SegundoApellido, Identificacion, Correo, Contrase�a, Telefono, NombreRol, FechaIncorporacion, Pasatiempo, NombreSedeXTEC>
-- Parametro de Salida: <Ninguno>
-- =============================================
...
-- Parametro de Entrada: <Nombre, PrimerApellido, SegundoApellido, Identificacion, Correo, Contrase�a, Telefono, NombreRol, NombreDepartamento>
-- Parametro de Salida: <Ninguno>
-- =============================================
...
-- Parametro de Entrada: <Nombre, PrimerApellido, SegundoApellido, Identificacion, Correo, Contrase�a, Telefono,NombreRol, IdentificadorCentroAcopio>
-- Parametro de Salida: <Ninguno>
-- =============================================
...
-- =============================================
-- Descripcion:	<Obtener peso reciclado por mes durante año meta>
-- Parametro de Entrada: <Ninguno>
-- Parametro de Salida: <Ninguno>
-- =============================================
...
-- =============================================
-- Descripcion:	<Obtener cantidad por mes de TEColones canjeados por tipo de beneficio durante año meta>
-- Parametro de Entrada: <Ninguno>
-- Parametro de Salida: <Ninguno>
-- =============================================
